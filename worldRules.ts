...
- **Clima General**: Generalmente húmedo y fresco en invierno, primavera y otoño, con cielos nublados. El verano es más seco y cálido.
- **Atmósfera**: La historia debe sentirse inmersiva y sensorial. Describe el olor a pergamino viejo, el frío de las mazmorras, la calidez de la sala común y la textura de la magia.

## ESTILO NARRATIVO Y LENGUAJE
- **Idioma del Diálogo**: Español neutro con matices naturales. Los adolescentes usan jerga apropiada, interrupciones y sarcasmo; no hablan como académicos.
- **Directivas de Estilo Narrativo**:
    - **Punto de Vista**: Tercera persona limitada, alternando generalmente entre la perspectiva de Harry y Aries.
    - **Tono**: Una mezcla de misterio, angustia adolescente (angst) y maravilla mágica. El tono debe ser maduro, reflejando el peligro real que enfrentan.
    - **Enfoque Visual**: Prioridad absoluta a las descripciones visuales de la ropa, el lenguaje corporal y los escenarios.

## PERSONAJES Y DINÁMICAS

### PERFILES PSICOLÓGICOS Y DINÁMICAS FAMILIARES

#### Aries Mauvignier (Aries Black)
- **Datos Vitales**: Nacida el **20 de junio de 1980**.
- **Identidad**: Hija de Sirius Black y Zahira Mauvignier. Usa el apellido de su madre para protegerse.
- **Trasfondo**:
...
- **Espacio Personal (Habitación en Grimmauld Place)**:
    ...
    - **Decoración (Pósters Específicos)**:
        1.  **Pink Floyd - The Dark Side of the Moon**: El icónico prisma refractando luz sobre fondo negro ocupa un lugar central. Para Aries, simboliza el análisis de la realidad y su miedo a la fragmentación mental ("Brain Damage").
        2.  **The Police - In Concert**: Un póster tipográfico grande en azul y blanco (estilo años 80). Refleja la energía cruda y directa que ella admira.
        3.  **Tears for Fears - Songs from the Big Chair**: La portada del álbum en blanco y negro con la banda seria. Escucha "Everybody Wants to Rule the World" con ironía política.
        4.  **Marillion - Script for a Jester's Tear**: La imagen del bufón triste tocando el violín en una habitación desordenada. Es una metáfora visual de su propia vida: actuando un papel mientras el mundo se desmorona.
        5.  **Rush**: El logo clásico de la banda. Rock progresivo complejo para una mente que nunca deja de pensar.

#### Harry Potter
- **Datos Vitales**: Nacido el **31 de julio de 1980**.
- **Edad Actual**: 15 años (5º curso).
- **Personalidad**: Temperamental, sarcástico, valiente, con fuerte síndrome del superviviente. En plena etapa de angustia adolescente (angst), desconfiado de la autoridad.
- **Apariencia Física (Estilo Grunge/Casual 90s)**:
    - **Rasgos**: Cabello negro azabache perpetuamente desordenado, ojos verdes brillantes, cicatriz en forma de rayo, complexión delgada pero nervuda (de Buscador). Gafas redondas.
    - **Vestimenta Civil**: Se aleja de la ropa de Dudley. Viste estilo "El Prisionero de Azkaban" pero más maduro.
        - **Prendas Clave**: Chaqueta tipo bomber de pana color granate/rojo oscuro o sudaderas con capucha gris desgastadas. Camisas de franela a cuadros (rojo/negro o verde/azul) abiertas sobre camisetas negras lisas.
        - **Inferior**: Jeans negros ajustados, a menudo rotos en las rodillas.
        - **Calzado**: Botas de combate de cuero marrón gastado o zapatillas de lona altas (tipo Converse) negras y sucias.
        - **Accesorio**: Bufandas largas de lana enrolladas descuidadamente.

#### Draco Malfoy
- **Edad Actual**: 15 años (5º curso, Slytherin).
- **Personalidad**: Arrogante, inteligente, conflictivo. Empieza a sentir el peso de las expectativas de los Mortífagos.
- **Apariencia Física (Estilo Dark Academia / Old Money)**:
    - **Rasgos**: Cabello rubio platino perfectamente peinado, facciones afiladas, ojos grises fríos. Postura rígida y elegante.
    - **Vestimenta Civil**: Riqueza generacional y sofisticación.
        - **Prendas Clave**: Cuellos de tortuga (turtlenecks) negros o azul marino profundo de cachemira. Sacos (blazers) cruzados de lana fría o abrigos largos (overcoats) estructurados de color gris carbón o negro.
...
- **Apariencia Física (Aristócrata Rebelde)**:
    ...
    - **Estilo de Vestimenta (Aristócrata Rockstar / Pirata Mágico)**:
        ...
        - **Prendas Clave**:
            ...
            - **Inferior**: Pantalones de sastre oscuros o de cuero, metidos en botas altas.
        - **Accesorios (El "Clutter" Mágico)**:
            - **Joyería en Capas**: Múltiples collares de plata de diferentes largos, anillos con piedras oscuras en varios dedos.
            - **Cadenas**: Una cadena de reloj de bolsillo que cuelga del chaleco o del cinturón.
            - **Pañuelos/Telas**: Pañuelos de seda estampada o retazos de tela ("rags") atados descuidadamente a la cintura (como un cinturón improvisado) o en la muñeca.
            - **Gafas**: Ocasionalmente usa gafas de sol tintadas (azules o ahumadas) en interiores.

#### Zahira Mauvignier
- **Identidad**: Madre de Aries, ex-pareja de Sirius. Bruja de gran poder y moralidad gris.
- **Historia**: Ayudó a Sirius a huir tras la muerte de los Potter. Vivió con él y Aries en Francia antes de regresar a Grimmauld Place.
- **Apariencia Física (Belleza Veela Letal)**:
    - **Rostro**: Facciones esculpidas y angulosas, de una simetría casi sobrenatural que resulta intimidante. Piel de porcelana fría que nunca parece envejecer. Expresión aristocrática y distante ("Resting Bitch Face" elegante).
    - **Ojos**: De un violeta eléctrico y penetrante, idénticos a los de Aries, pero con una mirada mucho más calculadora y cínica ("ojos de alguien que ha visto imperios caer").
    - **Cabello**: Rubio platino (casi blanco) cortado en un estilo "bob" francés elegante y texturizado o media melena con flequillo afilado. Moderno y cortante.
- **Estilo de Vestimenta (Cold War Chic / Lujo Letal)**:
    - **Concepto**: Una mezcla entre espía de la Guerra Fría y aristócrata moderna intocable. Ropa estructurada, monocromática y extremadamente costosa.
    - **Prendas Clave**:
        - **Abrigos**: Abrigos largos de lana (trench coats) estructurados en color blanco invierno (hueso), camel o negro profundo. A menudo llevados sobre los hombros o con el cuello alzado.
        - **Sastrería**: Blazers de terciopelo (verde esmeralda o negro) entallados, trajes de chaqueta con pantalones de corte masculino y camisas blancas de cuello rígido desabotonadas hasta el pecho.
        - **Tops**: Jerseys de cuello alto (turtlenecks) de cachemira negra o crema.
...
- **El Catalizador (Enamoramiento)**: El cambio ocurre tras los eventos en el Departamento de Misterios donde Sirius resulta herido (no muerto).
    1.  **Ruptura de la Armadura**: Harry ve a Aries colapsar por primera vez por el pánico de perder a su padre. La imagen de la "chica invencible" se rompe, revelando a alguien humana y frágil.
    2.  **Inversión de Roles**: Harry asume el rol de protector. Él la consuela usando la técnica de respiración que *ella* le enseñó ("cuatro adentro, cuatro afuera").
    3.  **Conexión**: Se enamoran porque comparten el mismo trauma fundamental (miedo a perder familia) y porque Harry descubre que, detrás de la frialdad estratégica de Aries, hay un corazón que siente con su misma intensidad.

## MAGIA Y ALQUIMIA (SISTEMA DE PODER)
- **Concepto General**: La Alquimia es la ciencia de la comprensión, descomposición y reconstrucción de la materia mágica. No es solo pociones; es manipular la realidad.
- **Magia de Aries**: Tiene una sensibilidad única a la "textura" de la magia. Puede sentir si un hechizo es "áspero", "frío" o "aceitoso".

### REGLAS DE LA ALQUIMIA (SISTEMA DURO)
1.  **Principio de Correspondencia**: Todo proceso alquímico requiere una relación simbólica y energética entre el objetivo de la transmutación y los elementos empleados. La fuerza del vínculo determina la estabilidad del resultado.
2.  **Triada Operativa**: Cada acto alquímico se compone de tres fases inseparables:
    *   **Entrada**: la materia, energía o concepto inicial que se somete a transformación.
    *   **Proceso**: la secuencia estructurada de acciones, fórmulas y voluntades que canalizan la transmutación.
    *   **Salida**: el resultado final, acompañado de sus efectos colaterales inevitables.
3.  **Equilibrio de Intercambio**: Nada se crea sin costo. Toda alteración exige una compensación proporcional en materia, energía o integridad del ejecutor. Eludir este principio provoca inestabilidad o corrupción del resultado.
4.  **Anclaje Simbólico**: Cada transmutación debe estar fijada a un patrón simbólico —rúnico, geométrico o verbal— que defina sus límites y evite la dispersión de la energía. La ausencia de anclaje conduce a efectos erráticos.
5.  **Resonancia Emocional**: La intención del ejecutor, modulada por su estado emocional, influye directamente en la forma y pureza del resultado. Estados internos inestables distorsionan la transmutación.
6.  **Temporalidad Precisa**: El momento de ejecución —medido en ciclos naturales, astrales o internos— condiciona la eficacia y seguridad del proceso. Alterar la sincronía reduce la potencia o incrementa el riesgo.
7.  **Ley de Contaminación**: Toda energía o materia utilizada conserva trazas de su origen. Dichas trazas pueden alterar el resultado o vincularlo permanentemente a su fuente.
8.  **Límite de Iteración**: Un mismo patrón alquímico pierde eficacia con usos repetidos sobre el mismo objetivo o ejecutor, acumulando desgaste y riesgo de fallo catastrófico.
9.  **Efectos Residuales**: Toda transmutación deja una huella física, energética o simbólica en el entorno y/o en el ejecutor. Estas huellas son acumulativas y, si no se gestionan, pueden volverse permanentes.
10. **Irreversibilidad Condicionada**: Algunas transmutaciones no pueden deshacerse sin un coste mayor que el de su ejecución original. La reversión, cuando es posible, sigue un patrón distinto y más exigente.
